...
import FileChangeDetector from "@/components/FileChangeDetector"; // Import the FileChangeDetector
import HmrStatus from "@/components/HmrStatus"; // Import the HMR status component
