      ...
      <div className="max-w-3xl px-6 py-12">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
              <li><strong>What is processed:</strong> The text content of your uploaded document is sent to a third-party AI service (Google Gemini) for analysis and data extraction.</li>
              <li><strong>Automatic PII Redaction:</strong> Before any document text is sent to the AI service, we automatically redact sensitive personal information including Social Security numbers, credit card numbers, bank account numbers, email addresses, phone numbers, license/ID numbers, and dates of birth.</li>
