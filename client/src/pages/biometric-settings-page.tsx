...
import { Fingerprint, Trash2, ShieldCheck, ArrowLeft } from "lucide-react";
          ...
          {!checked ? (
            ...
            <div className="text-center py-4">
              ...
              <p className="text-sm text-muted-foreground">
                Biometric login is not available on this device or browser. Make sure you're using Safari on iPhone or Chrome on Android.
              </p>
            </div>
          ) : (
            <>
