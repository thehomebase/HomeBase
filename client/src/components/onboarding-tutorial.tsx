...
import {
  ...
  Store, ChevronRight, ChevronLeft, X,
  Rocket, CheckCircle2, HelpCircle
} from "lucide-react";
...
const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    description: "Let's get you set up in under a minute. We'll show you the essentials — you can explore everything else at your own pace.",
    icon: Rocket,
    route: "/dashboard",
  ...
  },
  {
    ...
    description: "This is your command center. See your deal pipeline, key metrics, and upcoming deadlines at a glance. Customize what shows up with the settings gear.",
  ...
  {
    title: "Transactions",
    description: "Create and manage your deals here. Upload contracts for automatic data extraction, track documents with checklists, and monitor timelines from listing to close.",
    icon: FileText,
    route: "/transactions",
    category: "deals",
  },
  {
    title: "Clients",
    description: "Add buyers and sellers, invite them to their own portal, and manage the relationship through and beyond the transaction.",
    icon: Users,
    route: "/clients",
    category: "clients",
  },
  {
    title: "HomeBase Pros",
    description: "Find trusted home service professionals, rate their work, read reviews from other agents, and build your go-to vendor team.",
    icon: Store,
    route: "/marketplace",
    category: "tools",
  },
  {
    ...
    description: "Encrypted messaging, Gmail integration, SMS, and call logging — all your client communication in one place.",
    icon: MessageSquare,
    route: "/messages",
    category: "tools",
  },
  {
    title: "You're Ready!",
    description: "That's the essentials! Create your first transaction to get started. Explore Leads, Open Houses, Drip Campaigns, and more from the sidebar. Restart this tour anytime from the help button.",
    icon: CheckCircle2,
    route: "/dashboard",
    category: "getting-started",
  },
