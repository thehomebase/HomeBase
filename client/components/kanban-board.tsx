...
function KanbanColumn({ 
  ...
  return (
    <div ref={setNodeRef} className="flex flex-col min-w-[280px] bg-muted/50 rounded-lg p-3 dark:bg-gray-800/50">
    ...
    >
      ...
      <DragOverlay>
        {activeId && activeTransaction && activeTransaction.client ? (
          <Card className="p-3 w-[280px] shadow-lg cursor-grabbing dark:bg-gray-700">
