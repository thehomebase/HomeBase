...
- **ORM**: Drizzle ORM
- **Key Models**: Users (agent/client/vendor roles), Transactions, Clients, Documents, Checklists, Contractors, Messages, Saved Properties, Communications, Agent Phone Numbers, Email Snippets, Email Tracking, Inspection Items, Bid Requests, Bids, Home Team Members, Homeowner Homes, Home Maintenance Records, Referral Codes, Referral Credits, Drip Campaigns, Drip Steps, Drip Enrollments, Client Special Dates.
